    ...
    <header class="sticky top-0 z-40 dash-header">
        <div class="flex flex-wrap items-center justify-between px-4 py-3 gap-3">
            ...
            <div class="flex items-center gap-2">
                <button id="themeToggle" class="w-8 h-8 grid place-items-center rounded-lg border border-white/10 bg-white/5 text-neutral-400 hover:text-white hover:bg-white/10 transition" aria-label="Toggle theme">
