    ...
    <div class="w-full max-w-md bg-white border border-neutral-200 rounded-xl shadow-flat flex flex-col max-h-[90vh]">
        <div class="flex items-center justify-between px-6 py-4 border-b border-neutral-200">
            <h3 class="flex items-center gap-2 text-base font-semibold text-neutral-900">
                <i class="text-sm text-primary-600 fas fa-edit"></i> Edit Equipment
            </h3>
        ...
        <form id="edit-form" action="{{ route('admin.equipment.update') }}" method="POST" class="flex flex-col flex-1 min-h-0">
            ...
            <div class="px-6 py-5 space-y-4 overflow-y-auto flex-1">
                <div>
                    <label for="edit-name" class="block text-sm font-medium text-neutral-700">Equipment Name</label>
                ...
                <div>
                    <label for="edit-description" class="block text-sm font-medium text-neutral-700">Description</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="edit-quantity" class="block text-sm font-medium text-neutral-700">Total Quantity</label>
                    ...
                    <div>
                        <label for="edit-available" class="block text-sm font-medium text-neutral-700">Available Quantity</label>
            ...
            <div class="flex items-center justify-end gap-2 px-6 py-4 border-t border-neutral-200 bg-neutral-50">
                ...
                <button type="submit" id="save-edit" class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium rounded-md bg-primary-600 text-white hover:bg-primary-700">
