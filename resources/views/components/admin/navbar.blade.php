...
<div class="fixed inset-y-0 left-0 z-50 flex flex-col text-white sidebar w-80" style="background:#0c1222; border-right:1px solid rgba(255,255,255,0.06)">
    ...
    <div class="p-4 border-t border-white/5 space-y-3">
        ...
        <button id="themeToggle" class="w-full flex items-center justify-between px-3 py-2 rounded-lg border border-white/10 bg-white/5 text-xs font-medium text-[#cbd5e1] hover:bg-white/10 transition" aria-label="Toggle theme">
