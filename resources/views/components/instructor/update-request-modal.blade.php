...
<div id="edit-modal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black/50">
    <div class="modal-fade mx-4 w-full max-w-lg rounded-lg bg-white shadow-lg">
        ...
        <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
            ...
            <button id="cancel-edit" class="text-gray-400 transition hover:text-gray-600">
        ...
        <form id="edit-form" method="POST" action="{{ route('borrower.request.update') }}" class="space-y-4 p-6">
            ...
            <div>
                ...
                <textarea name="remarks" id="edit-remarks" rows="3"
                    class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"></textarea>
            </div>
