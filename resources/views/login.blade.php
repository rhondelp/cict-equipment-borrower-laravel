...
.lp-eyebrow { display: inline-flex; align-items: center; gap: 8px; font-size: 12px; font-weight: 700; letter-spacing: 0.10em; text-transform: uppercase; color: #5b8de0; margin-bottom: 18px; }
...
.lp-title { margin: 0 0 14px; font-size: clamp(32px,3.5vw,44px); font-weight: 800; line-height: 1.12; letter-spacing: -0.035em; color: #fff; }
.lp-sub { margin: 0 0 28px; font-size: 14.5px; line-height: 1.6; color: #64748b; }
/* Alerts */
.lp-alert { display: flex; align-items: center; gap: 10px; width: 100%; max-width: 380px; padding: 11px 16px; border-radius: 10px; font-size: 13px; font-weight: 500; }
...
/* Form */
.lp-form { display: flex; flex-direction: column; gap: 18px; width: 100%; max-width: 380px; }
.lp-field { display: flex; flex-direction: column; gap: 6px; }
.lp-remember { display: flex; align-items: center; gap: 10px; cursor: pointer; user-select: none; padding-top: 2px; }
.lp-remember span { font-size: 13px; font-weight: 500; color: #cbd5e1; }
