...
<div class="theme-shell">
    <div class="w-full max-w-6xl relative">
        <div class="grid items-center gap-10 px-6 lg:px-8 lg:grid-cols-12">
            ...
            <div class="lg:col-span-7 space-y-6 animate-fade-in">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-2">
                    <a href="{{ route('login') }}" class="btn-primary !w-auto px-7 py-3.5 rounded-xl">
                        Login to System <i class="fa-solid fa-arrow-right text-xs ml-1"></i>
                    </a>
            ...
            <div class="lg:col-span-5 flex justify-center lg:justify-end animate-fade-in" style="animation-delay:.15s">
                <div class="auth-card !max-w-[420px] !p-8 text-center">
                    ...
                    <h3 class="text-lg font-bold text-white tracking-tight">CICT Equipment Center</h3>
                    <p class="text-sm text-[#8b93a8] mt-1.5 leading-relaxed">College of Information &amp; Communications Technology<br>NMSCST</p>
